...
lib.ssMetadata = [
		{name:"davignon_Movie_Banner_AN_atlas_", frames: [[2479,0,800,480],[0,0,2477,690],[3281,0,220,240],[3798,0,135,150],[3644,0,152,150],[3935,0,96,150],[3503,0,139,240]]}
];
...
(lib.ActionmovieBackground = function() {
	this.spriteSheet = ss["davignon_Movie_Banner_AN_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.davignon_Movie_Banner_AN = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.text}]},155).to({state:[{t:this.text}]},33).to({state:[{t:this.text}]},2).to({state:[{t:this.instance_4}]},3).to({state:[{t:this.instance_5}]},42).to({state:[{t:this.instance_5},{t:this.instance_6}]},25).to({state:[{t:this.instance_7}]},78).to({state:[{t:this.instance_8}]},20).to({state:[]},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(338).to({_off:false},0).to({_off:true,regX:0.2,regY:-0.7,scaleX:0.21,scaleY:0.07,x:482.9,y:-19.1},20).wait(2));
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/davignon_Movie_Banner_AN_atlas_.png", id:"davignon_Movie_Banner_AN_atlas_"}
	],
	preloads: []
};
